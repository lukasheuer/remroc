...
ARGUMENTS = [
        ...
        DeclareLaunchArgument('world', default_value=world_name_default, description='Ignition world type.'),
        DeclareLaunchArgument(
                'number_of_humans',
                default_value=number_of_humans_default,
...
def generate_launch_description():
        ...
        gz_sim_resource_path = SetEnvironmentVariable(
                ...
                value=[Path(pkg_remroc).joinpath('worlds').as_posix() + ':' + Path(pkg_remroc_robots).joinpath('robots').as_posix()],
        )
                ...
                launch_arguments=[
                        (
                                ...
                                [
                                        ...
                                        '_',
                                        sample,
                                        '.sdf',  # The world to launch. Make sure there exists a corresponding sdf in "worlds/sdfs"
                                        ' -v 4',  # Verbose mode
                                        ' -r',  # start unpaused
        ...
        ld.add_action(gz_sim)  # Launching gazebo
        ...
        mapf_solver = Node(
                ...
                condition=IfCondition(
                        PythonExpression(
                                [
                                        "'",
                                        coordinator_sub,
                                        "' in ['coordinator_mapf', 'coordinator_mapf_baseline']",
                                ]
                        )
                ),
                output='screen',
                parameters=[
                        {
                                'mapf_file_path': [
                                        Path(pkg_remroc).joinpath('params').as_posix(),
                                        '/mapf_',
                                        map_name,
                                        '.yaml',
                                ]
        ...
        map_server = Node(
                ...
                parameters=[
                        ...
                        {
                                'yaml_filename': [
                                        Path(pkg_remroc).joinpath('worlds', 'maps').as_posix(),
                                        '/',
                                        map_name,
                                        '.yaml',
                                ]
        ...
        for i in range(len(starts)):
                ...
                robot_launch_node = Node(
                        ...
                        arguments=[
                                ...
                                world_name,
                                '-file',
                                Path(pkg_remroc_robots).joinpath('robots', robot_description, 'model.sdf').as_posix(),
                                '-name',
                                robot_name,
                                '-x',
                                str(robot_pose[0]),
                        ...
                        ld.add_action(
                                Node(
                                        ...
                                        arguments=[
                                                ...
                                                'base_link',
                                                '--child-frame-id',
                                                f'{robot_name}/{sensor_dict["sensor_frame_id"]}',
                                        ],
                ...
                ekf = Node(  # robot state-estimation using an extended kalman filter.
                ...
                amcl = Node(  # robot localization using AMCL
                        package='nav2_amcl',
                        executable='amcl',
                        namespace=robot_name,
                        respawn=True,
                ...
                controller = Node(  # robot controller, currently MPPI
                ...
                planner = Node(  # robot global planner, currently Hybrid A*
                ...
                behaviour_server = Node(  # behaviours
                ...
                bt_navigator = LifecycleNode(  # behaviour tree
        ...
        #                 on_completion=TimerAction(actions=[robot_experiment_node], period=30.0),
        #         )
        # )
        launch_experiment_node = RegisterEventHandler(
                OnStateTransition(
                        target_lifecycle_node=bt_navigator,
                        goal_state='active',
                        entities=[robot_experiment_node],
                )
        )
